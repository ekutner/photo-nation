...
## אורך מוקד של עדשה 
עדשות מצלמה בנויות ממספר רב של אלמנטים, שכל אחד מהם הוא עדשה ששוברת את קרני האור בנפרד. התייחסות לכל האלמנטים האלו היא גם מסובכת 
וגם תלויה במבנה הספציפי של כל עדשה, לכן, כדי לפשט את הדיון, נניח שמדבור בעדשה דקה, שנמצאת במרכז האפקטיבי של העדשה הגדולה. למי שזוכר פיזיקה
תיכונית, הדבר דומה להתייחסות למרכז המסה של גוף כנקודה במקום למבנה התלת מימדי המלא שלו.   
...
<br>
נזכיר בבשרטוט הקודם מישור האובייקט נמצא במרחק u מהעדשה ומישור התמונה שלו נמצא במרחק v ממנה. המרחקים $u_n$ ו-$u_f$ מסמנים 
...
עכשיו [ניזכר](/post/f-stops/#מספרי-צמצם) שההגדרה למספר צמצם היא $N=\frac{f}{D} $ ואחרי היפוך קטן מתקבל: $D=\frac{f}{N}$  
